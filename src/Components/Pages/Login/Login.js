...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="flex items-start min-h-screen lg:p-4 md:p-4 p-0 container mx-auto justify-center lg:pt-20 md:pt-20 pt-0">
        <div className="flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md">
          <div className="p-4 py-6 text-white bg-blue-500 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
            ...
            <div className="flex lg:justify-start md:justify-start justify-center items-center gap-x-2 cursor-pointer">
          ...
          <div className="lg:p-5 md:p-5 p-2 bg-white md:flex-1">
            ...
            <form onSubmit={handleLogin} className="flex flex-col space-y-5">
              ...
              <p className="flex flex-col items-center justify-center mt-10 text-center">
                ...
                <Link to="/signup">
                  <p className="underline text-[#2563eb] font-semibold">
                    Get Started!
                  </p>
                </Link>
              </p>
