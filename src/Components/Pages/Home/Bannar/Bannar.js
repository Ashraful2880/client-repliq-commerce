        ...
        <SwiperSlide className="slider-bg">
          ...
          <div className="absolute lg:left-[300px] md:left-[180px] left-[50px] lg:top-[100px] md:top-[100px] top-[50px] text-left">
            ...
            <Link to="/shopCategory/All">
              <button className="text-[17px] font-semibold mt-6 px-8 py-2.5 bg-white hover:bg-transparent text-orange-600 hover:text-white border border-white rounded-md duration-300">
                Shop Now
              </button>
            </Link>
          </div>
